    ...
    function resendOtp(){
        ...
        if(strcasecmp($content['status'], 'SUCCESS') == 0) {
            ...
            if($email_count != '' && $email_count >= 1){
                ...
                $this->setRedirect('index.php?option=com_miniorange_oauth&view=accountsetup&tab-panel=account', 'Another One Time Passcode has been sent <b>( ' .$email_count .' )</b> to <b>' . ( $admin_email) . '</b>. Please enter the OTP below to verify your email.');
