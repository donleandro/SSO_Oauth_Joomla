...
class MoOauthCustomer{
	...
	*/
	...
	function request_for_demo($email, $plan, $description)
	{
        ...
        $fromEmail 			= $email;
        $subject            = "MiniOrange Joomla Oauth Client Request for Demo";

        $content='<div>Hello, <br><br>Company :<a href="'.$_SERVER['SERVER_NAME'].'" target="_blank" >'.$_SERVER['SERVER_NAME'].'</a><br><br><b>Email :<a href="mailto:'.$fromEmail.'" target="_blank">'.$fromEmail.'</a></b><br><br><b>Demo for plugin: '.$plan. '</b><br><br><b>Description: ' .$description. '</b></div>';
        $fields = array(
...
public static function submit_feedback_form($email,$phone,$query)
	...
	$apiKey = "fFd2XcvTGDemZvbw1bcUesNJWEqKbbUq";
        ...
        $authorizationHeader= "Authorization: " . $hashValue;
        $fromEmail 			= $email;
        $subject            = "MiniOrange Joomla Feedback for Oauth Client[Free]  ";
	...
	function submit_contact_us( $q_email, $q_phone, $query ) {
		...
		$query = '[Joomla OAuth Client]: ' . $query;
		$fields = array(
